<template>
  <div id="app">
    <a href="https://github.com/luyilin/vue-cute-rate"
       class="github-corner"
       aria-label="View source on Github">
      <svg width="80"
           height="80"
           viewBox="0 0 250 250"
           style="fill:#f2c1d9; color:#fff; position: absolute; top: 0; border: 0; right: 0;"
           aria-hidden="true">
    ...
    <juri :doc-list="docList"
      ...
      <star-rate slot="demo-1"
                 :value="2.5"
                 type="star1"
                 :star-half="true"
                 :on-change="onChangeFn" />

      <star-rate slot="demo-2"
                 v-model="value"
                 type="star1" />
      <span slot="demo-2"
            class="text">{{ value }} stars</span>

      <star-rate slot="demo-3"
                 :value="2"
                 :disabled="true"
                 active-color="#d4237a"
                 type="heart" />

      <star-rate slot="demo-4"
                 :value="3"
                 :allow-clear="false" />
      <span slot="demo-4"
            class="text">allowClear: false</span>

      <star-rate slot="demo-5"
                 v-model="value1"
                 type="star1"
                 :star-half="true"
                 :hover-change="true"
      ...
      <span slot="demo-5"
            class="text">{{ value1 }} stars</span>

      <star-rate slot="demo-6"
                 :value="3"
                 active-color="lightpink"
                 inactive-color="#ccc"
                 hover-color="lightblue" />

      <star-rate slot="demo-7"
                 :value="3" />
      <span slot="demo-7"
            class="text">default type star</span>
      <br slot="demo">
      <star-rate slot="demo-7"
                 :value="4"
                 type="star1" />
      <span slot="demo-7"
            class="text">star1</span>
      <br slot="demo-7">
      <star-rate slot="demo-7"
                 :value="2"
                 active-color="#d4237a"
                 type="heart" />
      <span slot="demo-7"
            class="text">heart</span>

      <star-rate slot="demo-8"
                 :value="3.5"
                 :star-half="true">
      ...
      <star-rate slot="demo-8"
        ...
        <span slot="rateChar"
              slot-scope="props"
              :class="props.computeClass">V</span>
      </star-rate>

      <div slot="demo-9">
        <star-rate v-model="trueValue"
                   inactive-char="❌">
          <span slot="customChar"
                slot-scope="props"
